...
var _user$project$Main$viewTotalPrice = function (debugEntry) {
	var totalPrice = A2(
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('total-price'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$total = 0;
var _user$project$Main$newEntry = F3(
	function (desc, priceField, id) {
		return {description: desc, price: priceField, incart: false, editing: false, id: id};
	});
	...
	function (v) {
		return {
			entries: _elm_lang$core$Native_List.toArray(v.entries).map(
				function (v) {
					return {description: v.description, incart: v.incart, editing: v.editing, id: v.id, price: v.price};
				}),
			field: v.field,
			priceField: v.priceField,
			uid: v.uid,
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {entries: a, field: b, priceField: c, uid: d, visibility: e};
	});
var _user$project$Main$Entry = F5(
	function (a, b, c, d, e) {
		return {description: a, incart: b, editing: c, id: d, price: e};
	});
var _user$project$Main$ChangeVisibility = function (a) {
	return {ctor: 'ChangeVisibility', _0: a};
};
var _user$project$Main$visibilitySwap = F3(
		...
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$ChangeVisibility(visibility)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Main$viewControlsFilters = function (visibility) {
	return A2(
		...
		{
			ctor: '::',
			_0: A3(_user$project$Main$visibilitySwap, '#/', 'All', visibility),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(' '),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Main$visibilitySwap, '#/remaining', 'Remaining', visibility),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' '),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$visibilitySwap, '#/incart', 'In Cart', visibility),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	function (visibility, entries) {
		var debugEntry = A2(
			...
			A2(
				...
				entries));
		var entriesInCart = _elm_lang$core$List$length(
			A2(
				...
				entries));
		var entriesLeft = _elm_lang$core$List$length(entries) - entriesInCart;
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewTotalPrice, debugEntry),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewControlsFilters, visibility),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Main$CheckAll = function (a) {
...
var _user$project$Main$DeleteComplete = {ctor: 'DeleteComplete'};
var _user$project$Main$viewControlsClear = function (entriesInCart) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('clear-incart'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$hidden(
					_elm_lang$core$Native_Utils.eq(entriesInCart, 0)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$DeleteComplete),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(entriesInCart),
						')'))),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$UpdatePrice = F2(
	function (a, b) {
...
var _user$project$Main$viewEntry = function (item) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'incart', _1: item.incart},
					_1: {
						ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$checked(item.incart),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											A2(_user$project$Main$Check, item.id, !item.incart)),
										_1: {ctor: '[]'}
									}
								}
							}
						...
						_0: A2(
							_elm_lang$html$Html$label,
							{
								...
								_0: _elm_lang$html$Html_Events$onDoubleClick(
									A2(_user$project$Main$EditingEntry, item.id, true)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(item.price),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(
													_user$project$Main$UpdatePrice(item.id)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onBlur(
														A2(
															...
															item.id,
															!_elm_lang$core$String$isEmpty(item.price))),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$Delete(item.id)),
											_1: {ctor: '[]'}
										}
									},
									{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(item.description),
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(
																_user$project$Main$UpdateEntry(item.id)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onBlur(
																	A2(_user$project$Main$EditingEntry, item.id, false)),
																_1: {
																	ctor: '::',
...
var _user$project$Main$viewKeyedEntry = function (item) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toString(item.id),
		_1: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewEntry, item)
	};
};
var _user$project$Main$viewEntries = F2(
	function (visibility, entries) {
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('grocery-list'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewKeyedEntry,
						A2(_elm_lang$core$List$filter, isVisible, entries))),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$UpdatePriceField = function (a) {
	return {ctor: 'UpdatePriceField', _0: a};
};
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('new-price'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_('number'),
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(price),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$name('newPrice'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$UpdatePriceField),
													_1: {
														ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Add groceries'),
									_1: {
										ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('groceries'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Main$viewInput, model.field, model.priceField),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Main$viewEntries, model.visibility, model.entries),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Main$viewControls, model.visibility, model.entries),
							_1: {ctor: '[]'}
						}
					}
				}),
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							entries: _elm_lang$core$String$isEmpty(model.field) ? model.entries : A2(
								...
								{
									ctor: '::',
									_0: A3(_user$project$Main$newEntry, model.field, model.priceField, model.uid),
									_1: {ctor: '[]'}
								})
						}),
					{ctor: '[]'});
			...
			case 'UpdatePrice':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							entries: A2(_elm_lang$core$List$map, updatePrice, model.entries)
						}),
					{ctor: '[]'});
			case 'Delete':
				return A2(
							...
							return A2(
								...
								function (field) {
									return A2(
													...
													return A2(
														...
														function (visibility) {
															return _elm_lang$core$Json_Decode$succeed(
																{entries: entries, field: field, priceField: priceField, uid: uid, visibility: visibility});
														},
										...
										A2(_elm_lang$core$Json_Decode$field, 'priceField', _elm_lang$core$Json_Decode$string));
								},
														...
														return A2(
															...
															function (incart) {
																return A2(
																	...
																	function (price) {
																		return _elm_lang$core$Json_Decode$succeed(
																			{description: description, editing: editing, id: id, incart: incart, price: price});
																	},
																	A2(_elm_lang$core$Json_Decode$field, 'price', _elm_lang$core$Json_Decode$string));
															},
															A2(_elm_lang$core$Json_Decode$field, 'incart', _elm_lang$core$Json_Decode$bool));
													},
